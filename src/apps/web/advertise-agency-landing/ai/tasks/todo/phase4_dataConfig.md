...
3. **T28 ✅:** Create 3 example article JSONs:
   ...
   - `data/content/news/2026/04/company-update-2026.json`
   - `data/content/blog/2026/04/design-trends-2026.json`
4. **T29 ✅:** Update `.vscode/settings.json` — add `fileMatch` patterns for services/news/blog articles (done via generate-json-schemas.ts; auto-regenerated by script)
