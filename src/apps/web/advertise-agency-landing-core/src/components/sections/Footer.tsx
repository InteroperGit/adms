          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                ...
                aria-label="Telegram"
                className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 text-white/50 transition-colors hover:border-primary/50 hover:bg-primary/10 hover:text-primary"
              >
                <Send size={15} />
              </a>
              <a
