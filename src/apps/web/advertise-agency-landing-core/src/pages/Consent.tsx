    ...
    return (
        <main className="max-w-3xl mx-auto px-4 py-12 text-gray-800">
            ...
            <Section title="6. Срок действия согласия">
                ...
                <p>
                    6.2. По истечении срока персональные данные подлежат уничтожению или обезличиванию,
            ...
            <Section title="7. Порядок отзыва согласия">
                <p>
                    7.1. Субъект вправе отозвать настоящее согласие в любое время, направив письменный
                ...
                <p className="mt-3">
                    7.3. После получения отзыва Оператор прекращает обработку данных и уничтожает их в
                    течение <strong>30 (тридцати) дней</strong>, если иное не предусмотрено законодательством.
                </p>
            </Section>
            ...
            <Section title="8. Права субъекта">
                ...
                <ul className="list-disc pl-6 space-y-1 mt-2">
                    ...
                    <li>Обжаловать действия Оператора в Роскомнадзор (<a href="https://rkn.gov.ru" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:text-gray-900 transition-colors">rkn.gov.ru</a>) или в суд</li>
