...
// colors: HSL values without the "hsl()" wrapper, e.g. "17 93% 52%"
// fontUrls: Google Fonts stylesheet URLs injected into <head> by themePlugin
export default {
  colors: {
    background: '0 0% 100%',
    foreground: '230 20% 7%',
